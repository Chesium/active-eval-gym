...
\title[Boundary-Guided Training of Closed-Loop Controllers]{ESE6180 Project Proposal: (tentative title) From Evaluation to
...
half-lengths using \href{https://github.com/Chesium/active-eval-gym}{this experiment repository}
gives Figure~\ref{fig:regions}: quantized LQR and PPO have recovery regions
differing in shape, not only size, and survival and recovery disagree,
% since antisymmetrized PPO often survives from $\pm25^\circ$ without settling inside the band.
We ask whether evaluating that boundary can guide training that
